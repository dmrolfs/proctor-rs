...
async fn test_basic_sequence_3_fan_in_merge() -> Result<()> {
    ...
    let mut src_0 = stage::Sequence::new("src_ONES", (1..=9).into_iter().collect());
    let mut src_1 = stage::Sequence::new("src_TENS", (11..=99).into_iter().collect());
    let mut src_2 = stage::Sequence::new("src_HUNDREDS", (101..=999).into_iter().collect());
